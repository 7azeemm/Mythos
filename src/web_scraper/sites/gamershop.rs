...
static IMAGE_SEL: Lazy<Selector> = Lazy::new(|| Selector::parse("a.product-thumbnail img.product_image").unwrap());
static DESCRIPTION_SEL: Lazy<Selector> = Lazy::new(|| Selector::parse("div.product-des").unwrap());
...
static CONFIG: SiteConfig = SiteConfig {
    ...
    sections: &[
        ...
        (&Section::SSD, "https://gamershop.tn/395-disque-dur-ssd"),
